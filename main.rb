...
get "/" do
    @title = "Yassir Qattan's Portfolio"
    @description = "This site showcases all of the awesome things that Yassir Qattan has done."
    @home = "active"
    erb :home
end
...
get '/about' do
    @title = "About Me"
    @description = "This page provides a short bio for Yassir Qattan"
    @about = "active"
    erb :about
end
...
get '/works' do
    @title = "My Clips"
    @description = "This page provides links to Yassir Qattan's published clips"
    @works = "active"
    erb :work
end
